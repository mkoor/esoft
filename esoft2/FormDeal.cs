...
namespace esoft2
{
    public partial class FormDeal : Form
    {
        ...
        void ShowSupply()
        {
            ...
            foreach (SupplySet supplySet in Program.wft.SupplySet)
            {
        ...
        void ShowDemand()
        {
            ...
            foreach (DemandSet demand in Program.wft.DemandSet)
            {
                string[] item =
                {
        ...
        void ShowDealSet()
        {
            ...
            foreach (DealSet deal in Program.wft.DealSet)
            {
        ...
        void Deductions()
        {
            ...
            {
                SupplySet supplySet = Program.wft.SupplySet.Find(Convert.ToInt32(comboBoxSupply.SelectedItem.ToString().Split('.')[0]));
                DemandSet demand = Program.wft.DemandSet.Find(Convert.ToInt32(comboBoxDemand.SelectedItem.ToString().Split('.')[0]));
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DealSet deal = listViewDealSet.SelectedItems[0].Tag as DealSet;
                    Program.wft.DealSet.Remove(deal);
                    Program.wft.SaveChanges();
                    ShowDealSet();
                }
        ...
        private void comboBoxDemand_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            Deductions();
        }
    }
