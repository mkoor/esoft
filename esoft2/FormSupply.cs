...
namespace esoft2
{
    public partial class FormSupply : Form
    {
        ...
        void ShowRealEstate()
        {
            ...
            foreach (RealEstateSet realEstateSet in Program.wft.RealEstateSet)
            {
        ...
        void ShowSupplySet()
        {
            ...
            foreach (SupplySet supply in Program.wft.SupplySet)
            {
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SupplySet supply = listViewSupplySet.SelectedItems[0].Tag as SupplySet;
                    Program.wft.SupplySet.Remove(supply);
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
              ...
              comboBoxRealEstate != null && textBoxPrice.Text != "")
            {
                ...
                supply.IdRealEstate = Convert.ToInt32(comboBoxRealEstate.SelectedItem.ToString().Split('.')[0]);
                supply.Price = Convert.ToInt64(textBoxPrice.Text);
                Program.wft.SupplySet.Add(supply);
                Program.wft.SaveChanges();
                ShowSupplySet();
            }
